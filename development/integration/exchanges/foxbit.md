# Foxbit — Conector BipView

**Arquivo:** `exchanges/foxbit.md`  
**Docs oficiais:** <https://docs-otc.foxbit.com.br/>  

## Resumo

Spot; (doc público principal via Foxbit Invest/OTC); REST.
...
Documentação pública fragmentada (OTC/Invest); checar suporte à API de trading da conta principal.
