# Gemini — Conector BipView

**Arquivo:** `exchanges/gemini.md`  
**Docs oficiais:** <https://docs.gemini.com/>  

## Resumo

Spot; REST/WebSocket/FIX.
...
Catálogo focado em spot; limites estritos; alguns recursos exigem FIX para alto throughput.
