# Coinbase Exchange — Conector BipView

**Arquivo:** `exchanges/coinbase_exchange.md`  
**Docs oficiais:** <https://docs.cdp.coinbase.com/exchange/introduction/welcome>  

## Resumo

Spot; FIX/REST/WebSocket; Institutional (Prime/Exchange).
...
Diferenças entre Advanced Trade vs Exchange/Prime; rate limits; requisitos FIX para HFT.
