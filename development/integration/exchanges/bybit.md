# Bybit — Conector BipView

**Arquivo:** `exchanges/bybit.md`  
**Docs oficiais:** <https://bybit-exchange.github.io/docs/v5/intro>  

## Resumo

Spot, Derivativos (USDT/USDC/Inverse), Opções; V5 unificado; REST/WebSocket.
...
Migração V3→V5; unificação de produtos pode exigir adaptações; limites por IP/chave.
