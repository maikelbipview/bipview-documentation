# Crypto.com Exchange — Conector BipView

**Arquivo:** `exchanges/crypto_com.md`  
**Docs oficiais:** <https://exchange-docs.crypto.com/exchange/v1/rest-ws/index.html>  

## Resumo

Spot e Derivativos; REST/WebSocket/FIX.
...
Algumas features só via FIX; limites e whitelists; versões de endpoints v1/v2.
