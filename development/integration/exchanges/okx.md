# OKX — Conector BipView

**Arquivo:** `exchanges/okx.md`  
**Docs oficiais:** <https://www.okx.com/docs-v5/en/>  

## Resumo

Spot, Margin, Perpetuals, Futures, Options; Unified Accounts; Subcontas; REST/WebSocket.
...
Rate limits agressivos em algumas rotas; parâmetros UA; requer permissão por escopo; alguns dados exigem account-level.
