# Kraken — Conector BipView

**Arquivo:** `exchanges/kraken.md`  
**Docs oficiais:** <https://docs.kraken.com/>  

## Resumo

Spot; Futures (separado); REST/WebSocket/FIX.
...
Futures em stack separado; limites de requisição; nomenclatura de símbolos distinta (XBT vs BTC).
