# Gate.io — Conector BipView

**Arquivo:** `exchanges/gateio.md`  
**Docs oficiais:** <https://www.gate.com/docs/developers/apiv4/en/>  

## Resumo

Spot, Margin, Futures; REST/WebSocket.
...
V4 com múltiplos segmentos; alguns mercados de baixa liquidez; throttling por categoria.
