# Transfero (BaaSiC / BRZ) — Conector BipView

**Arquivo:** `exchanges/transfero.md`  
**Docs oficiais:** <https://docs.transfero.com/>  

## Resumo

On/Off-ramp (BRL↔BRZ), contas e pagamentos; REST; foco tesouraria.
...
Foco em pagamentos/contas, não é exchange; acesso via contrato; sandbox sob solicitação.
