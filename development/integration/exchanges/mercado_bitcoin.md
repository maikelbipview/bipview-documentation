# Mercado Bitcoin — Conector BipView

**Arquivo:** `exchanges/mercado_bitcoin.md`  
**Docs oficiais:** <https://api.mercadobitcoin.net/api/v4/docs>  

## Resumo

Spot; WebSocket/REST; BRL ramp.
...
Janelas históricas e limites por minuto; padronização de pares BRL; websockets v0.
